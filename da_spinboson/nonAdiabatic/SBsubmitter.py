...
#SBATCH --mem=60G
#SBATCH --job-name=nonAdia_c{c}T{T}_E{ene}_G{gam}
#SBATCH --output=./output/sl_c{c}_{T}_{ene}_{gam}.out
#SBATCH --error=./output/sl_c{c}_{T}_{ene}_{gam}.err
#SBATCH -c 12
#SBATCH -t 12000
python -u  non_adiabtic.py {ene} {T} {gam} {c} | gzip > out_{c}_{T}_{ene}_{gam}.gz
    """
