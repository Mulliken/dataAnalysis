...
#SBATCH --mem=60G
#SBATCH --job-name=paraRev_T{T}_E{ene}_G{gam}
#SBATCH --output=./output/sl_SBda1_{T}_{ene}_{gam}.out
#SBATCH --error=./output/sl_SBda1_{T}_{ene}_{gam}.err
#SBATCH -c 8
#SBATCH -t 12000
python -u  SBda1.py {ene} {T} {gam} | gzip > out_SBda1_{T}_{ene}_{gam}.gz
    """
